...
// SFML's SoundStream introduces additional buffers and has it's own polling mechanism which introduces extra lag.
// Effectively using it would mean relying on it's implementation-specific behaviour Using miniaudio is simpler as we
// just need to implement one audio callback
class AudioPlayer
{
public:
